...
public class Date{
    ...
    public Date ranDate() {
		// creates random day, month, and year.
		int ranDay   = (int) (Math.random() * 27) + 1;
		int ranMonth = (int) (Math.random() * 11) + 1;
		int ranYear  = (int) (2014 + (Math.random() * 14) + 1);
		// crates a Date object with the random data.
		Date ranDate = new Date(ranMonth,ranDay,ranYear);
		return ranDate;
